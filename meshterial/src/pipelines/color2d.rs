...
mod vs {
  vulkano_shaders::shader!{
    ty: "vertex",
    path: "src/shaders/color2d/vert.glsl"
  }
}
...
mod fs {
  vulkano_shaders::shader!{
    ty: "fragment",
    path: "src/shaders/color2d/frag.glsl"
  }
}

#[derive(Debug, Clone)]
pub struct VertexColor2 {
  pub position: [f32; 2],
  pub color: [f32; 4],
}
impl_vertex!(VertexColor2, position, color);


pub struct Color2DPipeline {
  ...
  pub fn new(
    ...
    let pipeline = Arc::new(
      ...
      // to the type of each vertex. But in this code it is automatically inferred.
        .vertex_input_single_buffer::<VertexColor2>()
